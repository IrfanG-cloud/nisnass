    ...
    return (
        <div className="md:flex px-10 py-20 bg-gray-100">
            <div className="md:w-3/5 bg-white rounded-2xl px-10">
                <h1 className="py-10 text-2xl font-bold">Dubai most far-sighted web agency</h1>
                <p className="py-6 text-xl">Okay maybe not so short-sighted. Of course we have eyes for what is right in front of us too. It is needed to be nimble in the turns. But we have been doing this for a long time now, and we know what works and what doesnot. Unlike ideas, solutions and opinions, value cannot arise in a short time. Therefore, we let patience, strategy and follow-up show the way.
