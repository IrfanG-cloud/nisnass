    ...
    <div className="bg-blue-300 px-10 ">
        ...
        <div className="md:flex">
                <div className="mb-8 mx-4 basis-1/3 bg-white p-10 rounded-2xl">
                    <h2 className="text-4xl font-bold">Conversion rate</h2>
                    <p className="py-10">
                ...
                <div className="mb-8 mx-4 basis-1/3 bg-blue-200 p-10 rounded-2xl">
                    <h2 className="text-4xl font-bold">Purchase trip</h2>
                    <p className="py-10">
                ...
                <div className="mb-8 mx-4 basis-1/3 bg-yellow-200 p-10 rounded-2xl">
                    <h2 className="text-4xl font-bold">Data Decides</h2>
                    <p className="py-10">
        ...
        <div className="py-10">
            ...
            <button className="bg-[#FED072] hover:bg-[#32154b] text-[#32154b] hover:text-white py-4 px-12 rounded-full text-2xl">
