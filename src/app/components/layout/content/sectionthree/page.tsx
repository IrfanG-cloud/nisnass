...
export default function SectionThree () {
  return (
    <>
    <div className="bg-gradient-to-b from-green-100 to-white px-10 py-20 ">
        ...
        <div className="py-10 mx-auto">
            ...
            <button className="bg-[#e72828] hover:bg-green-600 py-4 text-[#ffffff] hover:text-white px-12 rounded-full text-2xl">
